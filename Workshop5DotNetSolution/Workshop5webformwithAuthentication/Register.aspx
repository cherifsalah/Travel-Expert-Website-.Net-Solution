<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Workshop5webformwithAuthentication.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width: 35%">
        ...
        <tr>
            <td>
                <asp:Button ID="btnRegister" runat="server" Text="Register" BackColor="#666699" OnClick="btnRegister_Click" />
            </td>
            <td>
                <asp:Button ID="btnClear" runat="server" Text="Clear" BackColor="#666699" OnClick="btnClear_Click" />
            </td>
            <td>
